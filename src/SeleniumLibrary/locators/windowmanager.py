...
class WindowManager(ContextAware):
    ...
    def select(self, locator):
        ...
        return strategy(self.driver, criteria)

    def _select_by_title(self, driver, criteria):
