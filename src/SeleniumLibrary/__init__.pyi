class SeleniumLibrary:
    ...
    def alert_should_be_present(
        ...
        text: str = "",
        action: str = "ACCEPT",
        timeout: Optional[Union[float, str, None]] = None,
    ): ...
    ...
    def capture_element_screenshot(
        self, locator: str, filename: str = "selenium-element-screenshot-{index}.png"
    ): ...
    ...
    def click_button(self, locator: str, modifier: Union[str, None] = False): ...
    def click_element(
        self,
        locator: str,
        modifier: Union[str, None] = False,
        action_chain: bool = False,
    ): ...
    def click_element_at_coordinates(self, locator, xoffset, yoffset): ...
    def click_image(self, locator: str, modifier: Union[str, None] = False): ...
    def click_link(self, locator: str, modifier: Union[str, None] = False): ...
    ...
    def frame_should_contain(
        self, locator: str, text: str, loglevel: str = "TRACE"
    ): ...
    ...
    def go_to(self, url): ...
    def handle_alert(
        self, action: str = "ACCEPT", timeout: Optional[Union[float, str, None]] = None
    ): ...
    ...
    def open_browser(
        ...
        remote_url: Union[str, None] = False,
        desired_capabilities: Optional[Union[str, dict, None]] = None,
    ...
    def set_selenium_implicit_wait(self, value: str): ...
