...
class SeleniumLibrary:
    ...
    def create_webdriver(self, driver_name: str, alias: Optional[Optional] = None, kwargs = {}, **init_kwargs): ...
    ...
    def execute_async_javascript(self, *code: Union): ...
    def execute_javascript(self, *code: Union): ...
