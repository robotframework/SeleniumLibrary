...
class SeleniumLibrary:
    def __init__(
        ...
        screenshot_root_directory: Optional[Optional[str]] = None,
        plugins: Optional[Optional[str]] = None,
        event_firing_webdriver: Optional[Optional[str]] = None,
        page_load_timeout=timedelta(seconds=300.0),
    ...
    def add_cookie(
        ...
        domain: Optional[Optional[str]] = None,
        secure: Optional[Optional[bool]] = None,
        expiry: Optional[Optional[str]] = None,
    ): ...
    ...
    def alert_should_be_present(
        ...
        text: str = "",
        action: str = "ACCEPT",
        timeout: Optional[Optional[datetime.timedelta]] = None,
    ): ...
    ...
    def location_should_be(self, url: str, message: Optional[Optional[str]] = None): ...
    def location_should_contain(
        self, expected: str, message: Optional[Optional[str]] = None
    ): ...
    ...
    def open_browser(
        ...
        options: Optional[Optional[typing.Any]] = None,
        service_log_path: Optional[Optional[str]] = None,
        executable_path: Optional[Optional[str]] = None,
    ): ...
    ...
    def switch_window(
        ...
        timeout: Optional[Optional[str]] = None,
        browser: str = "CURRENT",
    ): ...
    ...
    def title_should_be(self, title: str, message: Optional[Optional[str]] = None): ...
