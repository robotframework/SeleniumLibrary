...
class ElementKeywords(LibraryComponent):
    ...
    @keyword
    def assign_id_to_element(self, locator: Union[WebElement, str, List[Union[WebElement,str]]], id: str):
    ...
    @keyword
    def element_should_be_disabled(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def element_should_be_enabled(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def element_should_be_focused(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    def element_should_be_visible(
        self, locator: Union[WebElement, str, List[Union[WebElement,str]]], message: Optional[str] = None
    ):
    ...
    def get_element_attribute(
        self, locator: Union[WebElement, str, List[Union[WebElement,str]]], attribute: str
    ) -> str:
    ...
    @keyword
    def get_property(
        self, locator: Union[WebElement, str, List[Union[WebElement,str]]], property: str
    ) -> str:
    ...
    @keyword
    def get_horizontal_position(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> int:
    ...
    @keyword
    def get_element_size(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> Tuple[int, int]:
    ...
    @keyword
    def cover_element(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
...
newDiv.parentNode.style.overflow = 'hidden';
    ...
    @keyword
    def get_value(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> str:
    ...
    @keyword
    def get_text(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> str:
    ...
    @keyword
    def clear_element_text(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def get_vertical_position(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> int:
    ...
    def _click_with_action_chain(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    def click_element_at_coordinates(
        self, locator: Union[WebElement, str, List[Union[WebElement,str]]], xoffset: int, yoffset: int
    ):
    ...
    @keyword
    def double_click_element(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def set_focus_to_element(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def scroll_element_into_view(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def drag_and_drop(
        self, locator: Union[WebElement, str, List[Union[WebElement,str]]], target: Union[WebElement, str, List[Union[WebElement,str]]]
    ):
    ...
    @keyword
    def mouse_down(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def mouse_out(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def mouse_over(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def mouse_up(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def open_context_menu(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def simulate_event(self, locator: Union[WebElement, str, List[Union[WebElement,str]]], event: str):
...
return !element.dispatchEvent(evt);
    ...
    @keyword
    def press_key(self, locator: Union[WebElement, str, List[Union[WebElement,str]]], key: str):
    ...
    @keyword
    def mouse_down_on_link(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def mouse_down_on_image(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]):
    ...
    @keyword
    def get_element_count(self, locator: Union[WebElement, str, List[Union[WebElement,str]]]) -> int:
