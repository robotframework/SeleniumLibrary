...
return !element.dispatchEvent(evt);
    ...
    def press_key(self, locator, key):
        ...
        lead by '\\\\' or double escaped ('\\\\\\\\') if using a NAMED KEY as described in the
        [https://selenium.googlecode.com/git/docs/api/py/webdriver/selenium.webdriver.common.keys.html|Selenium docs].
