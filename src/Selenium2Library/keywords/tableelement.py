...
class TableElementKeywords(Base):
    ...
    def get_table_cell(self, table_locator, row, column, loglevel='INFO'):
        ...
        table = self._table_element_finder.find(self.ctx.current_browser(), table_locator)
    ...
    def table_column_should_contain(self, table_locator, col, expected, loglevel='INFO'):
        ...
        `loglevel` argument.
        """
        element = self._table_element_finder.find_by_col(self.ctx.current_browser(), table_locator, col, expected)
        if element is None:
            self.ctx.log_source(loglevel)
    ...
    def table_footer_should_contain(self, table_locator, expected, loglevel='INFO'):
        ...
        `loglevel` argument.
        """
        element = self._table_element_finder.find_by_footer(self.ctx.current_browser(), table_locator, expected)
        if element is None:
            self.ctx.log_source(loglevel)
    ...
    def table_header_should_contain(self, table_locator, expected, loglevel='INFO'):
        ...
        `loglevel` argument.
        """
        element = self._table_element_finder.find_by_header(self.ctx.current_browser(), table_locator, expected)
        if element is None:
            self.ctx.log_source(loglevel)
    ...
    def table_row_should_contain(self, table_locator, row, expected, loglevel='INFO'):
        ...
        """
        element = self._table_element_finder.find_by_row(self.ctx.current_browser(), table_locator, row, expected)
        if element is None:
            self.ctx.log_source(loglevel)
    ...
    def table_should_contain(self, table_locator, expected, loglevel='INFO'):
        ...
        `loglevel` argument.
        """
        element = self._table_element_finder.find_by_content(self.ctx.current_browser(), table_locator, expected)
        if element is None:
            self.ctx.log_source(loglevel)
