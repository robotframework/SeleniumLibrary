...
Should Give Error Message When Content Not Found In Table Column
    ...
    ...    Column #2 in table identified by 'id:simpleTable' should have contained text 'simpleTable_C3'.
    ...    Table Column Should Contain    id:simpleTable    2    simpleTable_C3

Should Give Error Message When Column Number Out Of Bounds
    Run Keyword And Expect Error
    ...    Column #20 in table identified by 'xpath=//*[@id="simpleTable"]' should have contained text 'simpleTable_B3'.
    ...    Table Column Should Contain    xpath=//*[@id="simpleTable"]    20    simpleTable_B3
